    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container max-w-6xl mx-auto px-4 py-16">
        ...
        <div className="grid md:grid-cols-2 gap-12 mb-16">
          <div>
            <div className="w-full h-96 bg-gradient-to-br from-primary/20 to-secondary/20 rounded-lg shadow-lg flex items-center justify-center">
              <div className="text-center p-8">
                <Users className="h-24 w-24 mx-auto mb-4 text-primary/50" />
                <p className="text-muted-foreground">Dr. Arnold G. Shapiro</p>
              </div>
            </div>
          </div>
